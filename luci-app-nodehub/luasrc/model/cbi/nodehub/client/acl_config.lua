...
local has_gfwlist = api.fs.access("/usr/share/nodehub/rules/gfwlist")
local has_chnlist = api.fs.access("/usr/share/nodehub/rules/chnlist")
local has_chnroute = api.fs.access("/usr/share/nodehub/rules/chnroute")
