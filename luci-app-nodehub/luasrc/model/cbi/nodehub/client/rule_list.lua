...
local gfwlist_path = "/usr/share/nodehub/rules/gfwlist"
local chnlist_path = "/usr/share/nodehub/rules/chnlist"
local chnroute_path = "/usr/share/nodehub/rules/chnroute"
...
o.write = function(self, section, value)
	...
	sys.call("rm -rf /tmp/etc/nodehub_tmp/dns_*")
end
