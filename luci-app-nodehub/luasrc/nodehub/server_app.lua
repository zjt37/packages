...
local LOG_APP_FILE = "/dev/null"
local TMP_BIN_PATH = CONFIG_PATH .. "/bin"
local require_dir = "luci.nodehub."

local ipt_bin = sys.exec("echo -n $(/usr/share/nodehub/iptables.sh get_ipt_bin)")
local ip6t_bin = sys.exec("echo -n $(/usr/share/nodehub/iptables.sh get_ip6t_bin)")
