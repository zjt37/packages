...
function index()
	...
	-- 节点聚合
	entry({"admin", "services", "nodeagg", "settings"}, cbi("nodeagg/settings"), _("基本设置"), 1).dependent = true
	...
	entry({"admin", "services", "nodeagg", "log"}, template("nodeagg/log"), _("运行日志"), 99).leaf = true
end
