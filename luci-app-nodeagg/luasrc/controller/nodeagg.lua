...
function index()
	...
	entry({"admin", "services", "nodeagg", "node_list"}, cbi("nodeagg/node_list"), _("节点订阅"), 2).dependent = true
	entry({"admin", "services", "nodeagg", "subscribe"}, cbi("nodeagg/subscribe"), _("节点列表"), 3).dependent = true
