...
local has_gfwlist = api.fs.access("/usr/share/nodepool/rules/gfwlist")
local has_chnlist = api.fs.access("/usr/share/nodepool/rules/chnlist")
local has_chnroute = api.fs.access("/usr/share/nodepool/rules/chnroute")
