...
local gfwlist_path = "/usr/share/nodepool/rules/gfwlist"
local chnlist_path = "/usr/share/nodepool/rules/chnlist"
local chnroute_path = "/usr/share/nodepool/rules/chnroute"
...
o.write = function(self, section, value)
	...
	sys.call("rm -rf /tmp/etc/nodepool_tmp/dns_*")
end
