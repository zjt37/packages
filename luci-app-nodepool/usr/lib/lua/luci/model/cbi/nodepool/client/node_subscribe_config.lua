...
o = s:option(Flag, "boot_update", translate("Update Once on Boot"), translate("Updates the subscription the first time NodePool runs automatically after each system boot."))
o.default = 0
