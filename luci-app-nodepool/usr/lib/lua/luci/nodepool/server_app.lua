...
local require_dir = "luci.nodepool."

local ipt_bin = sys.exec("echo -n $(/usr/share/nodepool/iptables.sh get_ipt_bin)")
local ip6t_bin = sys.exec("echo -n $(/usr/share/nodepool/iptables.sh get_ip6t_bin)")
